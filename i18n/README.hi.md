...
- **Self-learning & self-improvement** — 3+ tool calls के बाद agent नया workflow skill के रूप में save करने पर विचार करता है; मौजूदा skill reuse करने पर agent चुपचाप self-assess करके gap मिलने पर autonomously patch करता है (low-signal patches रोकने के लिए confidence gate; हर patch पर version bump और CHANGELOG.md update होता है)
